...
class ChatPageState extends State<ChatPage> {
  ...
  void readLocal() {
    ...
    chat.updateDataFirestore(
      FirestoreConstant.pathUserCollection,
      currentUserId,
      {FirestoreConstant.chattingWith: peerId},
    );
  }
  ...
  Future uploadFile() async {
    ...
    UploadTask uploadTask = chat.uploadFile(imageFile!, fileName);
    try {
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      chat.sendMessage(content, type, groupChatId, currentUserId, widget.arguments.peerId);
      listScrollController.animateTo(0, duration: Duration(milliseconds: 300), curve: Curves.easeOut);
    } else {
      Fluttertoast.showToast(msg: 'Nothing to send', backgroundColor: ConstantColor.greyColor);
    }
  }
          ...
          children: <Widget>[
            messageChat.type == TypeMessage.text
                ...
                ? Container(
                    ...
                    width: 200,
                    decoration: BoxDecoration(color: ConstantColor.greyColor2, borderRadius: BorderRadius.circular(8)),
                              ...
                              loadingBuilder: (BuildContext context, Widget child, ImageChunkEvent? loadingProgress) {
                                ...
                                return Container(
                                  decoration: BoxDecoration(
                                    color: ConstantColor.greyColor2,
                ...
                children: <Widget>[
                  ...
                  messageChat.type == TypeMessage.text
                      ? Container(
                          ...
                          width: 200,
                          decoration:
                              BoxDecoration(color: ConstantColor.primaryColor, borderRadius: BorderRadius.circular(8)),
              ...
              isLastMessageLeft(index)
                  ? Container(
                      child: Text(
                        ...
                        style: TextStyle(color: ConstantColor.greyColor, fontSize: 12, fontStyle: FontStyle.italic),
                      ),
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 && listMessage[index - 1].get(FirestoreConstant.idFrom) == currentUserId) || index == 0) {
      return true;
    } else {
      return false;
    }
  ...
  Widget buildSticker() {
    return Expanded(
      child: Container(
        child: Column(
          children: <Widget>[
            Row(
              children: <Widget>[
                TextButton(
                  onPressed: () => onSendMessage('chat', TypeMessage.sticker),
                  child: Image.asset(
                ...
                TextButton(
                  onPressed: () => onSendMessage('google', TypeMessage.sticker),
                  child: Image.asset(
        ...
        decoration: BoxDecoration(
            border: Border(top: BorderSide(color: ConstantColor.greyColor2, width: 0.5)), color: Colors.white),
          ...
          Flexible(
            child: Container(
              child: TextField(
                ...
                style: TextStyle(color: ConstantColor.primaryColor, fontSize: 15),
                controller: textEditingController,
                decoration: InputDecoration.collapsed(
                  hintText: 'Type your message...',
                  hintStyle: TextStyle(color: ConstantColor.greyColor),
                ),
                focusNode: focusNode,
              ),
            ),
    ...
    return Flexible(
      child: groupChatId.isNotEmpty
          ? StreamBuilder<QuerySnapshot>(
              stream: chat.getChatStream(groupChatId, _limit),
